...
class Projects extends Component {
  ...
  render() {
    ...
    if (this.props.resumeProjects && this.props.resumeBasicInfo && this.props.resumeExperience) {
      var sectionName = this.props.resumeBasicInfo.section_name.projects;
      
      var jobs = this.props.resumeExperience.map(function (jobs, index) {
        const mainProjects = jobs.mainProjects;
              ...
              return (
                ...
                >
                  <span className="portfolio-item d-block">
                    <div className="foto" onClick={() => detailsModalShow(jobs)}>
                      <div>
                        <img
                          src={coverPhoto}
      ...
      <section id="portfolio">
        <div className="col-md-12">
          <h1 className="section-title" style={{ color: "black" }}>
            <span>{sectionName}2</span>
          </h1>
          <div className="col-md-12 mx-auto">
            <div className="row mx-auto">{jobs}</div>
          </div>
          <ProjectDetailsModal
